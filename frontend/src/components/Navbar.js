    ...
    <nav className="bg-gray-900 text-white sticky top-0 z-10">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="#" className="flex items-center space-x-3 rtl:space-x-reverse">
          <span className="self-center text-2xl font-semibold whitespace-nowrap">Gayatri Trading</span>
        </a>
        <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          ...
          >
            ...
            <svg
              className={`w-5 h-5 transition-transform transform ${isMenuOpen ? "rotate-90" : "rotate-0"}`}
        ...
        <div className={`items-center justify-between w-full md:flex md:w-auto md:order-1 ${isMenuOpen ? "" : "hidden"}`} id="navbar-cta">
          {!isAuth ? (
            ...
            <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-800 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-gray-900 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
                <Link to="/dashboard" className="block py-2 px-3 md:p-0 text-white hover:text-cyan-300 dark:text-gray-300">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/purchase" className="block py-2 px-3 md:p-0 text-white hover:text-cyan-300 dark:text-gray-300">
                  Purchase
                </Link>
              </li>
              <li>
                <Link to="/party" className="block py-2 px-3 md:p-0 text-white hover:text-cyan-300 dark:text-gray-300">
                  Party
                </Link>
              </li>
            </ul>
